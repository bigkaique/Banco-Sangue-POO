package br.senac.sp.banco.view;
...
import br.senac.sp.banco.dao.BancoSangueDao;
import br.senac.sp.banco.dao.ConnectionFactory;
import br.senac.sp.banco.model.BancoSangue;
import br.senac.sp.banco.model.Doador;
import br.senac.sp.banco.tablemodel.BancoDeSangueModel;
...
public class JanelaBanco extends JFrame implements ActionListener {
	...
	public JanelaBanco() {
		...
		try {
			dao = new BancoSangueDao(ConnectionFactory.getConexao());
			lista = dao.listar();
